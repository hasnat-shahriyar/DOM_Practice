...
document.getElementById("add_button").addEventListener("click", addToLocalStorage);
document.getElementById("remove_button").addEventListener("click", removeFromLocalStorage);
